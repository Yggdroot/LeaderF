...
function! leaderf#Colors#Maps()
    ...
    nnoremap <buffer> <silent> j             :exec g:Lf_py "colorschemeExplManager.moveAndPreview('j')"<CR>
    nnoremap <buffer> <silent> k             :exec g:Lf_py "colorschemeExplManager.moveAndPreview('k')"<CR>
    nnoremap <buffer> <silent> <Up>          :exec g:Lf_py "colorschemeExplManager.moveAndPreview('Up')"<CR>
    nnoremap <buffer> <silent> <Down>        :exec g:Lf_py "colorschemeExplManager.moveAndPreview('Down')"<CR>
    nnoremap <buffer> <silent> <PageUp>      :exec g:Lf_py "colorschemeExplManager.moveAndPreview('PageUp')"<CR>
    nnoremap <buffer> <silent> <PageDown>    :exec g:Lf_py "colorschemeExplManager.moveAndPreview('PageDown')"<CR>
