...
function! leaderf#Function#Maps()
    ...
    nnoremap <buffer> <silent> j             :exec g:Lf_py "functionExplManager.moveAndPreview('j')"<CR>
    nnoremap <buffer> <silent> k             :exec g:Lf_py "functionExplManager.moveAndPreview('k')"<CR>
    nnoremap <buffer> <silent> <Up>          :exec g:Lf_py "functionExplManager.moveAndPreview('Up')"<CR>
