...
function! leaderf#Git#StartInlineBlame() abort
    call timer_start(0, 'leaderf#Git#StartInlineBlameImpl')
endfunction
...
function! leaderf#Git#Commands() abort
    if !exists("g:Lf_GitCommands")
        let g:Lf_GitCommands = [
                    ...
                    \ {"Leaderf git diff --explorer --side-by-side":"view the diffs in an explorer tabpage, the diffs is shown in a side-by-side view"},
                    ...
                    \ {"Leaderf git log --explorer --side-by-side":"fuzzy search and view the log in an explorer tabpage, the diffs is shown in a side-by-side view"},
