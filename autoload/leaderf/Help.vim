...
function! leaderf#Help#Maps()
    ...
    nnoremap <buffer> <silent> j             :exec g:Lf_py "helpExplManager.moveAndPreview('j')"<CR>
    nnoremap <buffer> <silent> k             :exec g:Lf_py "helpExplManager.moveAndPreview('k')"<CR>
    nnoremap <buffer> <silent> <Up>          :exec g:Lf_py "helpExplManager.moveAndPreview('Up')"<CR>
    nnoremap <buffer> <silent> <Down>        :exec g:Lf_py "helpExplManager.moveAndPreview('Down')"<CR>
    nnoremap <buffer> <silent> <PageUp>      :exec g:Lf_py "helpExplManager.moveAndPreview('PageUp')"<CR>
    nnoremap <buffer> <silent> <PageDown>    :exec g:Lf_py "helpExplManager.moveAndPreview('PageDown')"<CR>
