...
function! leaderf#Line#Maps()
    ...
    nnoremap <buffer> <silent> j             :exec g:Lf_py "lineExplManager.moveAndPreview('j')"<CR>
    nnoremap <buffer> <silent> k             :exec g:Lf_py "lineExplManager.moveAndPreview('k')"<CR>
    nnoremap <buffer> <silent> <Up>          :exec g:Lf_py "lineExplManager.moveAndPreview('Up')"<CR>
    nnoremap <buffer> <silent> <Down>        :exec g:Lf_py "lineExplManager.moveAndPreview('Down')"<CR>
    nnoremap <buffer> <silent> <PageUp>      :exec g:Lf_py "lineExplManager.moveAndPreview('PageUp')"<CR>
